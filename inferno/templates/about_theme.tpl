<!-- about_theme -->
<div id="about_theme">
	<div class="block-header2">Theme: <font color="white">Inferno (converted to EDK. Design by DzinerStudio)</font></div>
<p>
	<a href="http://gate.eveonline.com/profile/vecati">
		<img src="{$theme_url}/img/theme.png" alt="Inferno by Vecati" />
	</a>
</p>
